 ...
 *
 * Date: Wed, 13 Jun 2012 18:29:21 GMT
 */
(function() {
  ...
  _.extend(Tower, {
    ...
    createConnection: function(socket) {
      var connection;
      connection = Tower.Net.Connection.create().setProperties({
        socket: socket
      });
  ...
  */
    ...
    __defineProperty(Application,  "listen", function() {
      ...
      if (Tower.history && Tower.history.enabled) {
        Tower.history.Adapter.bind(global, "statechange", function() {
          ...
          return Tower.stateManager.handleUrl(location.path, params);
        });
  ...
  Tower.Store = (function(_super) {
    ...
    __defineProperty(Store,  "fetch", function(criteria, callback) {
      var _this = this;
      return Tower.Net.Connection.transport.find(criteria, function(error, records) {
        if (callback) {
  ...
  Tower.Store.Memory.Finders = {
    ...
    _calculateDistances: function(records, nearCoordinate) {
      ...
      for (_i = 0, _len = records.length; _i < _len; _i++) {
        ...
        _results.push(record.__distance = Tower.Support.Geo.getDistance(center, coordinates));
      }
      return _results;
    },
    _prepareConditionsForTesting: function(conditions) {
      if (!(_.isPresent(conditions) && (conditions.coordinates != null))) {
        return;
      }
    ...
    _conditionsUseGeo: function(conditions) {
      ...
      for (key in conditions) {
        ...
        if (_.isPresent(value['$near']) || _.isPresent(value['$maxDistance'])) {
          return true;
        }
      }
    }
  ...
  Tower.Store.Transport.Ajax = {
    ...
    failure: function(data, callback) {
      var _this = this;
    ...
    create: function(records, callback) {
      ...
      for (_i = 0, _len = records.length; _i < _len; _i++) {
        ...
        _results.push((function(record) {
          var json, url;
          record.set('id', void 0);
          json = _this.toJSON(record);
    ...
    findSuccess: function(criteria, callback) {
      var _this = this;
      return function(data, status, xhr) {
        try {
    ...
    findFailure: function(criteria, callback) {
      return this.failure(criteria, callback);
    },
    find: function(criteria, callback) {
      var params,
        _this = this;
      params = this.serializeParamsForFind(criteria);
      this.queue(function() {
        return _this.ajax(params).success(_this.findSuccess(criteria, callback)).error(_this.findFailure(criteria, callback));
      });
      return void 0;
    },
    serializeParamsForFind: function(criteria) {
      var data, url;
  ...
  Tower.Model.Scope = (function() {
    ...
    __defineStaticProperty(Scope,  "finderMethods", ['find', 'all', 'first', 'last', 'count', 'exists', 'fetch', 'instantiate', 'pluck', 'live', 'toArray']);
    ...
    __defineProperty(Scope,  "toArray", function() {
    ...
    __defineProperty(Scope,  "fetch", function(callback) {
    ...
    __defineProperty(Scope,  "toCursor", function() {
      return this.compile();
    });
  ...
  Tower.Model.Cursor.Finders = {
    ...
    currentPage: 0,
    publish: function() {
      return this.constructor.subscriptions.pushObject(this);
    },
    firstPage: function() {
      this.page(1);
      return this;
  ...
  Tower.Model.Cursor.Operations = {
    ...
    testEach: function(records, callback) {
      ...
      return Tower.Store.Operators.testEach(records, conditions, callback);
    },
  ...
  Tower.Model.Cursor.Persistence = {
    ...
    _insert: function(callback) {
      ...
      if (this.instantiate) {
        ...
        this.store.insert(this, function(error, __records) {
          if (callback) {
            callback.call(_this, error, __records);
          }
          if (!error) {
            return Tower.notifyConnections('create', __records);
          }
        });
      }
      return this;
    ...
    _update: function(callback) {
      ...
      if (this.instantiate) {
        ...
        this.store.update(updates, this, function(error, records) {
          if (callback) {
            callback.call(_this, error, records);
          }
          if (!error) {
            return Tower.notifyConnections('update', records);
          }
        });
      }
      return this;
    ...
    _destroy: function(callback) {
      ...
      if (this.instantiate) {
        ...
        this.store.destroy(this, function(error, records) {
          ...
          if (!error) {
            return Tower.notifyConnections('destroy', records);
          }
        });
      }
      return this;
  ...
  Tower.Model.Cursor.Serialization = {
    ...
    toJSON: function() {
      var conditions, data, limit, page, sort;
      data = {};
      sort = this.get('order');
      conditions = this.conditions();
    ...
    attributes: function() {
      var attributes, conditions, value, _j, _key, _len1, _ref1, _value;
      attributes = {};
      _ref1 = this._where;
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        conditions = _ref1[_j];
  ...
  Tower.Model.Data = (function() {
    ...
    __defineProperty(Data,  "unsavedRelations", function() {
      var relations, result, value, _ref1;
  ...
  Tower.View.Form = (function(_super) {
    ...
    function Form(args, options) {
      ...
      if (typeof this.model === "string") {
        klass = (function() {
          try {
            return Tower.constant(Tower.Support.String.camelize(this.model));
          } catch (_error) {}
        }).call(this);
        if (klass) {
  ...
  Tower.View.Form.Field = (function(_super) {
    ...
    __defineProperty(Field,  "toId", function(options) {
      ...
      result = typeof this.model === 'object' ? Tower.Support.String.parameterize(this.model.constructor.className()) : this.model;
    ...
    __defineProperty(Field,  "toParam", function(options) {
      ...
      result = typeof this.model === 'object' ? Tower.Support.String.camelize(this.model.constructor.className(), true) : this.model;
      if (options.parentIndex) {
        result += "[" + options.parentIndex + "]";
      }
  ...
  Tower.View.ComponentHelper = {
    formFor: function() {
      ...
      return (_ref7 = Tower.View.Form).render.apply(_ref7, [_c].concat(__slice.call(arguments)));
    },
    tableFor: function() {
      var _c, _ref7;
      _c = typeof __cc === 'undefined' ? __ck : __cc;
      return (_ref7 = Tower.View.Table).render.apply(_ref7, [_c].concat(__slice.call(arguments)));
    },
    widget: function() {},
  ...
  Tower.Controller.Instrumentation = {
    InstanceMethods: {
      call: function(request, response, next) {
        ...
        if (typeof this.params.conditions === 'string') {
          this.params.conditions = JSON.parse(this.params.conditions);
        }
  ...
  Tower.Controller.Metadata = {
    ClassMethods: {
      ...
      metadata: function() {
        var baseClassName, belongsTo, callbackChain, callbacks, className, collectionName, helpers, layout, metadata, mimes, params, renderers, resourceName, resourceType, result, scopeNames, scopes, subscriptions, superMetadata, _ref7;
        className = this.className();
        metadata = this.metadata[className];
        if (metadata) {
          return metadata;
  ...
  Tower.Controller.Params = {
    ClassMethods: {
      param: function(key, options) {
        return this.params()[key] = Tower.Net.Param.create(key, options);
      },
      params: function() {
        var arg, value, _len7, _p;
        if (arguments.length) {
    ...
    InstanceMethods: {
      ...
      _buildCursorFromPost: function(cursor) {
        var conditions, limit, page, params, parsers, sort, value;
  ...
  Tower.Controller.Resourceful = {
    ClassMethods: {
      ...
      actions: function() {
        var actions, actionsToRemove, args, options, _len7, _p;
        args = _.flatten(_.args(arguments));
        options = _.extractOptions(args);
  ...
  Tower.Controller.Instrumentation = {
    enter: function(action) {
      return Ember.changeProperties(function() {
        ...
        this.set(_.toStateName(action), true);
        return this.set('format', 'html');
      });
    },
    call: function(router, params) {
      ...
      return this.runCallbacks('action', {
        ...
        return method.call(controller, params, callback);
      });
    },
    exit: function(action) {
      Ember.changeProperties(function() {
        this.set('isActive', false);
        return this.set(_.toStateName(action), false);
      });
      method = this[action];
      if (typeof method === 'object' && method.exit) {
        return method.exit.call(controller);
      }
    },
    clear: function() {},
    metadata: function() {
  ...
  Tower.Controller.States = {
    ...
    findEmberView: function(options) {
      if (options.view) {
        ...
        return App.get(_.camelize(options.template));
      }
    },
    renderWithEmber: function(options) {
      var outletOptions;
      outletOptions = {
        name: options.outlet || 'view',
        view: this.findEmberView(options),
        context: options.data || this.get('content')
      };
      return this.parentController().connectOutlet(outletOptions);
    }
  };
  ...
  Tower.Controller.reopenClass({
    extended: function() {
      ...
      return {
        instance: function() {
          return Tower.Application.instance().get(camelName);
        }
      };
    }
  });
  ...
  Tower.Net.Param = (function() {
    ...
    __defineStaticProperty(Param,  "separator", '-');
  ...
  Tower.Net.Param.Array = (function(_super) {
    var Array;
  ...
  Tower.Net.Param.Date = (function(_super) {
    var Date;
  ...
  Tower.Net.Param.Number = (function(_super) {
    var Number;
  ...
  Tower.Net.Param.Order = (function(_super) {
    var Order;
    ...
    __defineProperty(Order,  "parse", function(value) {
      var array, string, values, _len7, _p,
        _this = this;
      values = [];
      array = value.toString().split(/\s*,/);
      for (_p = 0, _len7 = array.length; _p < _len7; _p++) {
  ...
  Tower.Net.Param.String = (function(_super) {
    var String;
  ...
  Tower.Net.Route = (function(_super) {
    var Route;
    ...
    __defineStaticProperty(Route,  "findByUrl", function(url) {
      var route, _len7, _p, _ref7;
      _ref7 = this.all();
      for (_p = 0, _len7 = _ref7.length; _p < _len7; _p++) {
        route = _ref7[_p];
        if (route.match(url)) {
    ...
    __defineStaticProperty(Route,  "findByControllerOptions", function(options) {
      var controller, route, success, value, _len7, _p, _ref7;
      _ref7 = this.all();
      for (_p = 0, _len7 = _ref7.length; _p < _len7; _p++) {
        route = _ref7[_p];
    ...
    __defineProperty(Route,  "toControllerData", function(url, params) {
      var capture, controller, i, keys, match, _len7, _p;
      if (params == null) {
        params = {};
      }
  ...
  Tower.Net.Route.DSL = (function() {
    ...
    __defineProperty(DSL,  "match", function() {
      ...
      route = new Tower.Net.Route(this._extractOptions.apply(this, arguments));
      return Tower.Net.Route.create(route);
    });
  ...
  Tower.Net.Connection = (function(_super) {
    var Connection;
    ...
    Connection = __extends(Connection, _super);

    __defineStaticProperty(Connection,  "transport", void 0);

    __defineStaticProperty(Connection,  "controllers", []);

    __defineStaticProperty(Connection,  "handlers", Ember.Map.create());

    __defineStaticProperty(Connection,  "initialize", function() {
      if (Tower.modules.socketio) {
        return this.reopenClass(Tower.Net.Connection.Socketio);
      } else {
        return this.reopenClass(Tower.Net.Connection.Sockjs);
      }
    });

    __defineStaticProperty(Connection,  "addHandler", function(name, handler) {
      return this.handlers.set(name, handler);
    });

    __defineProperty(Connection,  "registerHandlers", function() {
      var _this = this;
    ...
    __defineProperty(Connection,  "resolve", function(action, records, callback) {
    ...
    __defineProperty(Connection,  "notifyTransport", function(action, records) {
      if (this.constructor.transport != null) {
        return this.constructor.transport[action](records, callback);
      }
    });

    __defineProperty(Connection,  "destroy", function(callback) {
      return callback();
    });

    __defineProperty(Connection,  "on", function(eventType, handler) {
  ...
  Tower.Net.Agent.prototype.request = function(method, path, options, callback) {
    var url;
    if (typeof options === "function") {
      callback = options;
      options = {};
  ...
  Tower.Net.Connection = (function(_super) {
    ...
    __defineStaticProperty(Connection,  "connect", function(socket, callback) {
      var _this = this;
      return socket.on('connect', function() {
        var connection, id;
        id = _this.getId(socket);
        connection = Tower.Net.Connection.create({
          socket: socket
        }).connect();
        connection.id = id;
    ...
    __defineStaticProperty(Connection,  "disconnect", function() {
      var _this = this;
      if (!Tower.connection) {
        return;
      }
    ...
    __defineProperty(Connection,  "notify", function(action, records) {
      if (!(records instanceof Array)) {
        records = [records];
      }
      return this.clientDidChange(action, records);
    });
    ...
    __defineProperty(Connection,  "clientDidChange", function(action, records) {
      var _this = this;
      return this.resolve(action, records, function(error, matches) {
        return _this["clientDid" + (_.camelize(action))](matches);
      });
    });

    __defineProperty(Connection,  "serverDidChange", function(data) {
    ...
    __defineProperty(Connection,  "clientDidCreate", function(records) {
      return this.notifyTransport('create', records);
    });

    __defineProperty(Connection,  "clientDidUpdate", function(records) {
      return this.notifyTransport('update', records);
    });

    __defineProperty(Connection,  "clientDidDestroy", function(records) {
      return this.notifyTransport('destroy', records);
    });

    __defineProperty(Connection,  "notifyTransport", function(action, records, callback) {
      if (this.constructor.transport != null) {
        return this.constructor.transport[action](records, callback);
      }
    });
  ...
  Tower.router = Ember.Router.create({
    ...
    handleUrl: function(url, params) {
      ...
      if (route) {
        ...
        return Tower.stateManager.transitionTo(route.state, params);
      } else {
    ...
    createControllerActionState: function(name, action) {
      ...
      return Ember.State.create({
        enter: function(router, transition) {
          ...
          if (controller) {
            return controller.enter(action);
          }
        },
        connectOutlets: function(router, params) {
          ...
          controller = Ember.get(Tower.Application.instance(), name);
          if (controller) {
            return controller.call(router, params);
          }
        },
...
*/
  ...
  Tower.Net.Route.DSL.prototype.match = function() {
    var route;
    this.scope || (this.scope = {});
    route = new Tower.Net.Route(this._extractOptions.apply(this, arguments));
  ...
  _.extend(Tower.Middleware.Router, {
    find: function(request, response, callback) {
      ...
      return Tower.Net.Route.findController(request, response, callback);
    },
